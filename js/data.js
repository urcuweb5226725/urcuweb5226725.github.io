...
const DYP_STOCKS = [
    {
        ...
        scuttlebutt: {
            score: 90,
            employeeRating: 4.2, source: "Glassdoor 4.2/5",
            customerNPS: 72, supplierRelation: "强势但公平",
            rdStrength: "A+",
            detail: "费雪闲聊法AI扫描：Glassdoor员工评分4.2（科技行业前10%），\"work-life balance\"负面提及率仅12%。供应链调研：台积电、富士康等核心供应商评价苹果\"要求极高但付款及时\"。客户端：NPS=72（行业最高），用户论坛中\"换到Android\"的讨论极少。研发投入$300亿/年但纪律性强——不乱烧钱。"
        },
        aiInsight: "AAPL 是段永平投资哲学的完美体现：简单易懂的商业模式、极其优秀的企业文化、强大的回购+分红。费雪闲聊法验证：员工口碑、客户忠诚度、供应商关系全部优秀。唯一不足是当前估值不在\"击球区\"。AI建议：耐心等待回调到$170-175区间，或者在当前价位小仓位建仓后逢低加仓。"
    },
    {
        ticker: "GOOGL", name: "Alphabet Inc.", price: 172.80,
        totalScore: 84,
        ...
        scuttlebutt: {
            score: 78,
            employeeRating: 4.3, source: "Glassdoor 4.3/5",
            customerNPS: 58, supplierRelation: "N/A（轻资产）",
            rdStrength: "A+",
            detail: "费雪闲聊法AI扫描：Glassdoor员工评分4.3但近年\"组织臃肿\"提及率上升至35%。广告客户反馈：Google Ads仍是\"不可替代的获客渠道\"，但CPM上涨引发不满。开发者社区：GCP口碑良好但市场份额仍远落后AWS。研发能力毋庸置疑（DeepMind、Waymo），但商业化效率被批评为\"研究院文化\"。"
        },
        aiInsight: "GOOGL 在段永平框架下是\"安全边际\"得分最高的科技巨头——PE 22x接近历史底部。费雪闲聊法显示：广告客户依赖度极高但内部效率存在改善空间。AI建议：当前价位可以开始建仓，但要理解AI搜索的不确定性。"
    },
    {
        ...
        scuttlebutt: {
            score: 88,
            employeeRating: 3.8, source: "旗下子公司平均 3.8/5",
            customerNPS: 65, supplierRelation: "长期合作",
            rdStrength: "B（非研发驱动型）",
            detail: "费雪闲聊法AI扫描：伯克希尔旗下企业（GEICO、See's Candies、BNSF等）员工评价普遍正面，管理层稳定。保险客户满意度高于行业均值。供应商和被投企业对巴菲特的评价一致：\"说到做到，不干预经营\"。费雪最看重的\"管理层对困难的坦诚度\"——巴菲特的股东信是全世界最坦诚的企业沟通。"
        },
        aiInsight: "BRK.B 在企业文化评分上是满分级别——巴菲特+Abel的组合是段永平最推崇的管理团队。费雪闲聊法验证：旗下企业口碑一致正面，管理层坦诚度无人能及。AI建议：任何时候买入BRK.B都不会太错，但最佳买点是在大盘恐慌时。"
    },
    {
        ...
        scuttlebutt: {
            score: 88,
            employeeRating: 4.2, source: "Glassdoor 4.2/5",
            customerNPS: 62, supplierRelation: "生态伙伴型",
            rdStrength: "A+",
            detail: "费雪闲聊法AI扫描：Glassdoor评分在Nadella时代从3.4升至4.2——这是企业文化转型的硬指标。企业客户调研：CIO们说\"微软是最不可能被替换的供应商\"。Copilot AI的付费意愿调查：68%的试用企业愿意续费。开发者社区：GitHub（8000万+用户）和VS Code统治级地位。"
        },
        aiInsight: "MSFT 商业模式和企业文化都是顶级水平。费雪闲聊法亮点：员工评分在Nadella时代大幅提升，企业客户锁定程度极高。但当前PE 35x安全边际不足。AI建议：建议在$350-370区间（PE 28-30x）加大仓位，现在可以小仓位持有。"
    },
    {
        ...
        scuttlebutt: {
            score: 85,
            employeeRating: 3.9, source: "Glassdoor 3.9/5",
            customerNPS: 55, supplierRelation: "装瓶厂深度绑定",
            rdStrength: "B+（品牌驱动非研发驱动）",
            detail: "费雪闲聊法AI扫描：全球装瓶厂合作伙伴关系稳定超50年——费雪说\"看供应商关系就知道公司品格\"。消费者调研：品牌认知度全球第一，但\"健康\"标签上得分偏低。员工文化偏传统，创新活力不如科技公司但胜在稳定。竞品（百事）员工跳槽意愿低，说明可口可乐的雇主品牌强。"
        },
        aiInsight: "KO 是段永平\"看懂生意\"维度的满分标的——全世界最简单的商业模式。费雪闲聊法验证：与装瓶厂50年+的合作关系是最好的企业品格证明。AI建议：投资组合\"压舱石\"，最佳策略是定投，在市场恐慌时加仓。"
    },
    {
        ...
        scuttlebutt: {
            score: 95,
            employeeRating: 4.0, source: "Glassdoor 4.0/5（零售业第1）",
            customerNPS: 79, supplierRelation: "强势谈判但长期合作",
            rdStrength: "B+（运营驱动型）",
            detail: "费雪闲聊法AI扫描：Costco员工满意度是零售业第一——时薪$29（行业均值$17），离职率仅6%（行业60%）。这完美验证了费雪的\"员工关系是护城河\"理论。会员续费率93%是最硬的客户满意度指标。供应商虽然利润被压薄，但\"一旦进入Costco销量就爆炸\"。Kirkland自有品牌NPS高达82。"
        },
        aiInsight: "COST 商业模式和企业文化都是A+级别。费雪闲聊法完美验证：员工薪资零售业最高→离职率最低→服务质量最好→会员续费93%。但PE 53x严重缺乏安全边际。AI建议：等PE 35-40x区间再出手。"
    },
    {
        ticker: "META", name: "Meta Platforms", price: 585.20,
        totalScore: 76,
        ...
        scuttlebutt: {
            score: 68,
            employeeRating: 3.8, source: "Glassdoor 3.8/5（下降趋势）",
            customerNPS: 32, supplierRelation: "N/A（轻资产）",
            rdStrength: "A（AI领域强）",
            detail: "费雪闲聊法AI扫描：Glassdoor评分从4.3降至3.8——2023年大裁员后\"人心不稳\"的信号。\"管理层透明度\"负面评价达42%。广告客户反馈：ROI仍然是最高的（优于Google），但对隐私政策变化的担忧增加。用户端：年轻人流向TikTok趋势明显，但Reels在追赶。开发者社区：Llama开源获好评。"
        },
        aiInsight: "META 在段永平框架下呈现矛盾：商业模式A级但企业文化C级。费雪闲聊法揭示关键风险：员工评分下降+管理层透明度差评42%。AI建议：如果你能接受CEO风险，PE 24x是性价比不错的选择，但不是\"买了忘记\"型。"
    },
    {
        ticker: "NVDA", name: "NVIDIA Corp.", price: 875.50,
        totalScore: 70,
        ...
        scuttlebutt: {
            score: 82,
            employeeRating: 4.4, source: "Glassdoor 4.4/5（科技业前5%）",
            customerNPS: 68, supplierRelation: "极强话语权",
            rdStrength: "A+（绝对领先）",
            detail: "费雪闲聊法AI扫描：Glassdoor 4.4分且\"CEO认可度\"高达97%——黄仁勋是最受员工爱戴的科技CEO之一。客户端：云厂商说\"没有替代品，必须买NVDA\"（CUDA生态锁定）。供应商：台积电为NVDA优先分配产能，说明议价能力极强。研发：AI芯片架构遥遥领先，但费雪会警告\"技术领先不等于永久护城河\"。"
        },
        aiInsight: "NVDA 在段永平框架下得分不高——\"看不太懂+太贵\"。但费雪闲聊法给出不同信号：员工评分4.4+客户完全锁定+研发绝对领先。这是段永平和费雪会产生分歧的典型案例。AI建议：如果你更认同费雪的\"研发驱动成长\"理念，可以适度配置。"
    }
];
